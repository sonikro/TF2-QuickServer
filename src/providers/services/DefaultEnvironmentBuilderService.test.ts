...
import { Region, RegionConfig, VariantConfig, getRegionDisplayName } from "../../core/domain";
...
vi.mock("../../core/domain", async (importOriginal) => {
    const actual = await importOriginal<typeof import("../../core/domain")>();
    return {
        ...actual,
